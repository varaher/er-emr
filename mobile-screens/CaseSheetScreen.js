    ...
    try {
      ...
      const payload = {
        ...
        examination: {
          ...
          general_pallor: toBoolean(fd.general_pallor),           // bool
          general_icterus: toBoolean(fd.general_icterus),         // bool
          general_clubbing: toBoolean(fd.general_clubbing),       // bool
          general_lymphadenopathy: toBoolean(fd.general_lymphadenopathy), // bool
          general_thyroid: toStringOrEmpty(fd.general_thyroid) || "Normal",
          general_varicose_veins: toBoolean(fd.general_varicose_veins), // bool
          general_notes: toStringOrEmpty(fd.general_notes),
          general_additional_notes: toStringOrEmpty(fd.general_additional_notes),
          // CVS - strings except pulse_rate (int)
          ...
          cvs_pulse_rate: toIntOrNull(fd.cvs_pulse_rate),         // int or null
          cvs_apex_beat: toStringOrEmpty(fd.cvs_apex_beat),
          cvs_precordial_heave: toStringOrEmpty(fd.cvs_precordial_heave), // string
